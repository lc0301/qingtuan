...
//	               	dy_id=node.getAttribute('data-id');
//	               	mui.ajax('http://192.168.43.176:8081/dynamic/delete/'+dy_id,{
//	               	dataType:'json',
//                  type:'get',
//                  timeout:10000,
//                  xhrFields: {
 ...
 */
    function reply(box, el) {
        ...
        commentBox.innerHTML ='<div class="comment-content">' +
        ...
        commentList.appendChild(commentBox);
        	        ...
        	        dy_id=el.getAttribute('data-id');
	               	var content=$("#textarea").val();
	               	mui.ajax('http://192.168.43.176:8081/dynamic/c_comment',{
	               	dataType:'json',
                    type:'POST',
                    data:{'content':textarea.value,'dy_id':dy_id},
                    timeout:10000,
                    xhrFields: {
          		    withCredentials: true
       				 },
